 ...
 * case the mode would be SYNCHRONOUS, if the input have to be polled, but the change of an output can be triggered at
 * any time, the mode would be SYNCHRONOUS_INPUTS. If the I/O is completely event based, the mode is EVENT_BASED.
 * 
